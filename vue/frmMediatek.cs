...
namespace Mediatek86.vue
{
    ...
    public partial class FrmMediatek : Form
    {
        ...
        private void DgvLivresEtat_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            VideLivresZones();
            string titreDesColonnes = dgvLivresEtat.Columns[e.ColumnIndex].HeaderText;
            List<Livre> sortedList = new List<Livre>();
            switch (titreDesColonnes) // n°d'exemplaire, date d'achat, libélé de l'Etat
            {
                case "Id":
                    sortedList = lesLivres.OrderBy(o => o.Id).ToList();
                    break;
